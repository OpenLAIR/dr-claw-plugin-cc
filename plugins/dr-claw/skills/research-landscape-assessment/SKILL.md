...
```
TREND_SCANNER=scripts/trend_scanner.py (from trending-research-scanner skill)
SEARCH_LOCAL=scripts/search_papers.py (from cache or skill directory)
ASSESS=scripts/assess_landscape.py (in this skill directory)
CACHE=.cache/trending-research/assessments (project-local cache)
```
